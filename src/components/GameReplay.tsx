      ...
      <div className="bg-slate-900 rounded-2xl border-2 border-slate-700 max-w-6xl w-full max-h-[95vh] overflow-hidden flex flex-col">
        ...
        <div className="bg-gradient-to-r from-purple-600 to-blue-600 p-4">
          <div className="flex justify-between items-center">
            ...
            <button onClick={onClose} className="text-white hover:bg-white/20 rounded-lg px-4 py-2 transition-all">
              ✕ Cerrar
            </button>
          </div>
          ...
          {analyzing && (
            <div className="mt-4 bg-white/10 rounded-lg p-3 backdrop-blur">
              <div className="flex items-center gap-3 mb-2">
                <span className="text-white font-semibold">🤔 Analizando con Stockfish...</span>
